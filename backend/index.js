...
const stegnoCollection = require("./stegno");

const translateCollection = require("./translate");

const codeCollection = require("./code");

const mythologyCollection = require("./mythology");

const logicCollection = require("./logic");

const dialogueCollection = require("./dialogue");

const inputCollection = require("./input");
